...
DeTurckForce::DeTurckForce(int dimension, int n) : CurveFlow(dimension, n)
{
    F = new double[(n+2)*dimension]();
}

void DeTurckForce::getRightHandSide(const double& t, double* u, double* fu)
{
    getPartialLength(u);
    getForce();
